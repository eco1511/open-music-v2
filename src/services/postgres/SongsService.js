...
class SongsService {
    ...
    async editSongById(id, {
        ...
        if (!result.rows.length) {
            throw new NotFoundError(`Gagal memperbarui lagu. Lagu dengan id ${id} tidak ditemukan.`);
        }
    }
    ...
    async deleteSongById(id) {
        ...
        if (!result.rows.length) {
            throw new NotFoundError(`Gagal menghapus lagu. Lagu dengan id ${id} tidak ditemukan.`);
        }
    }
}
